...
public class Game extends Model{
    ...
    private ArrayList<Muffin> topMuffins;
    private ArrayList<CupcakeBot> topCupcakes;
    private ArrayList<Muffin> aliveTopMuffins;
    private ArrayList<CupcakeBot> aliveTopCupcakes;

    private ArrayList<Muffin> rightMuffins;
    private ArrayList<CupcakeBot> rightCupcakes;
    private ArrayList<Muffin> aliveRightMuffins;
    private ArrayList<CupcakeBot> aliveRightCupcakes;

    private ArrayList<Muffin> bottomMuffins;
    private ArrayList<CupcakeBot> bottomCupcakes;
    private ArrayList<Muffin> aliveBottomMuffins;
    private ArrayList<CupcakeBot> aliveBottomCupcakes;

    private ArrayList<Muffin> leftMuffins;
    private ArrayList<CupcakeBot> leftCupcakes;
    private ArrayList<Muffin> aliveLeftMuffins;
    private ArrayList<CupcakeBot> aliveLeftCupcakes;

    private ArrayList<CupcakeSpawnerObject> cupcakeSpawners;
    ...
    public Game(Controller ctrl, HighScoreHandler hs) {
        ...
        topMuffins = new ArrayList<>();
        topCupcakes = new ArrayList<>();
        aliveTopMuffins = new ArrayList<>();
        aliveTopCupcakes = new ArrayList<>();
        rightMuffins = new ArrayList<>();
        rightCupcakes = new ArrayList<>();
        aliveRightMuffins = new ArrayList<>();
        aliveRightCupcakes = new ArrayList<>();
        bottomMuffins = new ArrayList<>();
        bottomCupcakes = new ArrayList<>();
        aliveBottomMuffins = new ArrayList<>();
        aliveBottomCupcakes = new ArrayList<>();
        leftMuffins = new ArrayList<>();
        leftCupcakes = new ArrayList<>();
        aliveLeftMuffins = new ArrayList<>();
        aliveLeftCupcakes = new ArrayList<>();
